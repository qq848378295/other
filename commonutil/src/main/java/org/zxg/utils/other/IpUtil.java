...
public class IpUtil {
     ...
     */
    public static String getIpAddress111(HttpServletRequest request) {
    ...
    public static String getPublicIp() {
        try {
            String path = "http://ip.taobao.com/service/getIpInfo.php?ip=myip";//
            ...
            Map map = JsonUtil.json2map(buffer.toString());
            if (map.containsKey("data") && ((Map) map.get("data")).containsKey("ip")) {
                return ((Map) map.get("data")).get("ip").toString();
            }
            return null;
        } catch (Exception e) {
